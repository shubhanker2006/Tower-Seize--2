...
function draw() {
  ...
  py1.display((229, 116, 117), "cyan")
  py2.display((229, 116, 117), "cyan")
  py3.display((229, 116, 117), "cyan")
  py4.display((110, 71, 102), "cyan")
  py5.display((110, 71, 102), "cyan")
  py6.display((251, 189, 76), "cyan")
  ...
  textSize(35);
  fill(0);
  text("DragAnd Release The Ball To Destroy The Boxes", 100, 385)
  fill("orange");
  textSize(20);
